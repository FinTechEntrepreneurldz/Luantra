...
const UniversalModelInterface = () => {
  ...
  const handlePredict = async () => {
    ...
    setPrediction({
      ...
      model_version: 'PRICE 1758576909173 Endpoint-v1.0'
    });
    setIsLoading(false);
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <main className="max-w-4xl mx-auto p-6">
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-white mb-4">PRICE 1758576909173 Endpoint</h1>
          ...
          <div className="bg-black/30 backdrop-blur-sm rounded-2xl border border-purple-500/30 p-6">
            ...
            {prediction ? (
              ...
              <div className="text-center py-8 text-gray-400">
                ...
                <p>Enter data above and click "Get Prediction" to see results</p>
              </div>
            )}
          </div>
        </div>
